# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
# Script to Analyze Raw Results and Generate PDF with Heatmaps (ATP)
#
# Helper script that exposes 'generate_diffusion_plots' function.
...
generate_diffusion_plots <- function(
  ...
  processed_results_by_sd <- foreach(
    ...
    for (current_threshold_mean_proc in THRESHOLD_MEAN_SWEEP_LIST) {
      ...
      # General Pre-calc: adopters_prop, prop_rational_OF_POPULATION, prop_social_OF_POPULATION

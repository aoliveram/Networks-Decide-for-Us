...
\end{tikzpicture}\\[-1pt]
{\scriptsize \textbf{Path 1 — vary $H$ at fixed $T$:} exponent $\delta$.}\\[7pt]
...
\end{tikzpicture}\\[-1pt]
{\scriptsize \textbf{Path 2 — vary $T$:} a continuous (2nd-order) \emph{or} discontinuous (1st-order) transition; exponent $\gamma$.}
\column{0.48\textwidth}
\footnotesize

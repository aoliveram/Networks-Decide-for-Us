...
\begin{itemize}\footnotesize
  ...
  \item Randomization $\Rightarrow$ \emphr{$\gamma\approx4$} — not a real critical exponent; rewire the network and the mean-field behavior is lost.
\end{itemize}
\end{columns}
\end{frame}
...
\begin{itemize}\small
  ...
  \item Even when a single case feels abrupt — or adoption is bimodal — the aggregate follows the
        familiar \emphr{Rogers S-curve}, across diffusions as different as fax machines, hashtags,
        and protest waves.
\end{itemize}
\vspace{0.2cm}
\begin{center}\small

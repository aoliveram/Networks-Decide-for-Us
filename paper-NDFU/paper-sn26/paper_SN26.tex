...
\begin{table}[H]
    ...
    \begin{tabular}{lcc}
    \toprule
    \textbf{Variable} & \textbf{Model 1 ($\beta$)} & \textbf{Model 2 ($\beta$)} \\
    \midrule
    ...
    \addlinespace
    \textit{Temporal Interactions ($2004 \times d_{ij}$)} \\
    Different race $\times$ Year & -- & $0.264$ \\
    Different religion $\times$ Year & -- & $-0.215^{*}$ \\
    Different sex $\times$ Year & -- & $0.144^{**}$ \\
    Education diff. $\times$ Year & -- & $-0.005$ \\
